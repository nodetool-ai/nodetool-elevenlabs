...
class TextToSpeech(GraphNode):
    ...
    voice_settings: dict | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Optional voice settings to override defaults"
    )
    ...
    optimize_streaming_latency: int | GraphNode | tuple[GraphNode, str] = Field(
        default=2,
    ...
    def get_node_type(cls):
        return "elevenlabs.text_to_speech.TextToSpeech"
